                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                {!! Form::model($brand,['url' => route('brand.update',['brand' => $brand->id]),'method'=>'put','enctype' => 'multipart/form-data']) !!}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        {!! Form::text('website',$brand->website,['class' => 'form-control']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        {!! Form::text('width',$brand->width,['class' => 'form-control']) !!}
                                    </div>
                                    {!! Form::label('height', 'طول عکس',['class' => 'col-form-label']) !!}
                                    <div class="col-sm-4">
                                        {!! Form::text('height',$brand->height,['class' => 'form-control']) !!}
                                    </div>
                                </div>

                                <div class="form-group row">
                                    {!! Form::submit('ویرایش برند',['class' => 'btn btn-primary']) !!}
                                </div>
