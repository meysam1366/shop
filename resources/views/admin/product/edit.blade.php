                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                ...
                                {!! Form::model($product,['url' => route('product.update',['product' => $product->id]),'method'=>'put','enctype' => 'multipart/form-data']) !!}
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        {!! Form::textarea('excerpt',$product->excerpt,['class' => 'form-control excerpt']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        {!! Form::textarea('details',$product->details,['class' => 'form-control details']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        {!! Form::select('category_id',$categories,$product->category_id,['class' => 'form-control categories']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        {!! Form::select('brand_id',$brands,$product->brand_id,['class' => 'form-control categories']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        {!! Form::text('width',$product->width,['class' => 'form-control']) !!}
                                    </div>
                                    {!! Form::label('height', 'طول عکس',['class' => 'col-form-label']) !!}
                                    <div class="col-sm-4">
                                        {!! Form::text('height',$product->height,['class' => 'form-control']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    {!! Form::submit('ویرایش محصول',['class' => 'btn btn-primary']) !!}
                                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            CKEDITOR.replace( 'details',{
                // customConfig: config.basicEntities = false
            } );
        });
    </script>
